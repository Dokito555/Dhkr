package blue.umbrella.dhkr.Data.Dhikr
...
object DhikrData {
    ...
    val listQauliyah: ArrayList<Dhikr>
        get() {
            val list = arrayListOf<Dhikr>()
    ...
    val listDzikir: ArrayList<Dhikr>
        get() {
            val list = arrayListOf<Dhikr>()
    ...
    val listDzikirPagi: ArrayList<Dhikr>
        get() {
            val list = arrayListOf<Dhikr>()
    ...
    val listDzikirPetang: ArrayList<Dhikr>
        get() {
            val list = arrayListOf<Dhikr>()
